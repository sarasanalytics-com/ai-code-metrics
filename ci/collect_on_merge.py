...
def classify_commit(message: str) -> str:
    ...
    for co_author in co_authors:
        ...
        if "copilot" in co_author:
            return "copilot"
        if "junie" in co_author or "jetbrains" in co_author:
            return "junie"
        if "gemini" in co_author or "google" in co_author:
            return "gemini"
    ...
    if "generated by cursor" in msg_lower:
        return "cursor"
    if "generated by junie" in msg_lower or "[junie]" in msg_lower:
        return "junie"
    if "generated by gemini" in msg_lower or "[gemini]" in msg_lower:
        return "gemini"
...
def write_job_summary(summary: dict):
    ...
    for tool, stats in sorted(breakdown.items()):
        icon = {"claude": "🤖", "windsurf": "🏄", "copilot": "🧑‍✈️", "cursor": "🖱️", "junie": "🧩", "gemini": "💎", "human": "👤"}.get(tool, "❓")
        lines.append(
    ...
    if gitai_stats and gitai_stats.get("ai_additions", 0) > 0:
        ...
        for key in breakdown:
            ...
            tool_map = {
                ...
                "gemini": "gemini", "google_gemini": "gemini",
                "gemini_cli": "gemini",
            }
